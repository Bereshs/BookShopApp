...
(function ($) {
    ...
    $(function () {
                ...
                init: function () {
                    ...
                    $('.form_search').on('submit', function (e) {
                        ...
                        if (pageSearch) {
                            ...
                            };getData('/api/books/search/page/' + $this.find('.search-input').val(), {
                                offset: 0,
        ...
        Author().init();
        var Authors = function () {
            var tagTemplate = function (tag) {
                return '<div class="Tag ' + tag.sizeClass + '"><a href="/tags/' + tag.id + '">' + tag.name + '</a> &nbsp;</div>';
            }
            return {
                init: function () {
                    $('[data-tag]').on('click change', function (e) {
                        var $this = $(this), data = $this.data('tag');
                        e.preventDefault();
                        ...
                        function getData(address, data, type) {
                            ...
                            $.ajax({
                                ...
                                complete: function (result) {
                                    if (result.status === 200) {
                                        var data = '';
                                        result.responseJSON.forEach(function (tag) {
                                            data += tagTemplate(tag);
                                        });
                                        var $Tag = $('.Section-header');
                                        if ($Tag.length > 0) {
                                            $Tag.last().after('<div class="Section-header">' + data + '</div>');
                                        }
                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'popular':
                                ...
                                break;
                            case'genre':
                                getData('/api/books/genre/' + $this.data('refreshid') + '/page', {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset < 1) {
                                            $this.data('refreshoffset', ++oldOffset)
                                ...
                                break;
                            case'author':
                                getData('/api/books/author/' + $this.data('refreshid') + '/page', {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset < 1) {
                                            $this.data('refreshoffset', oldOffset++)
                                ...
                                break;
                            case'tag':
                                getData('/api/books/tag/' + $this.data('refreshid') + "/page", {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset < 1) {
                                            $this.data('refreshoffset', ++oldOffset)
                            ...
                            postData('/approveContact', data, function (result) {
                                if (result.result=="true") {
                                    ...
                                    if (result) {
                                        ...
                                        $row.find('.form-input_mail, .form-input_phone').addClass('form-input_error').after('<div class="form-error"> Ошибка: ' + result.error + '</div>');
                                    } else {
                                ...
                                postData('/login', $this.data('send'), function (result) {
                                    if (result != null && result.result) {
                                        ...
                                        if (result) {
                                            ...
                                            $thisStep.find('.form-input:not(.form-input_hide)[type="text"]').addClass('form-input_error').after('<div class="form-error">' + "Пользователь не найден" + '</div>');
                                        }
                                    }
                                })
                            }
        ...
        var Profile = function () {
            ...
            return {
                init: function () {
                    ...
                    $('[data-action="save_profile"]').on('click', function (e) {
                        var $this = $(this);
                        e.preventDefault();
                        Login().postData('/profile/save', {
                            name: $('#name').val(),
                            phone: $('#phone').val(),
                            mail: $('#mail').val(),
                            ...
                            if (result.result) {
                                $('.Profile-success').text("Профиль успешно сохренен");
                                $('.Profile-success').css("color", "");
                            } else {
                                $('.Profile-success').text("Ошибка сохранения");
                                $('.Profile-success').css("color", "red");
                            }
                    ...
                    $('input[name="mail"], input[name="phone"]').on('change', function () {
                        ...
                        $row.find('.Profile-btn_confirm').show(0);
                        $row.find('.Profile-btn_confirm').find('.btn_primary').on('click', function () {
                            var data = {contact: $this.val()};
                            Login().postData('/requestEmailConfirmation', data, function (result) {
                                if (result.result) {
                                    $this.after('<div class="form-info">Вам направлен код подтверждения в письме на почту</div>')
                                    $row.find('.btn').attr('disabled', 'disabled');
                                    $row.find('.form-input_code').show(0);
                               } else {
                                    $row.find('.form-input[type="text"]').addClass('form-input_error').after('<div class="form-error">' + result.error + '</div>');
                                }
                            })
                        })
                        $row.find(".form-input_code").on('blur', function() {
                            var $this = $(this), data = {
                                contact: $row.find('.form-input_mail, .form-input_phone').val(),
                                code: $row.find('.form-input_code').val()
                            }, $but = $row.find('.btn');
                            var code=$row.find('.form-input_code').val();
                            if (!$this.hasClass('form-input_error') && code.length>=6) {
                                Login().postData('/approveContact', data, function (result) {
                                    if(result.result=="true") {
                                        ...
                                        $but.after('<div class="form-info">Код успешно подтвержден</div>');
                                        $this.trigger('change');
                                        $('button[data-action="save_profile"]').click();
                                    } else {
                                        if (result) {
                                            $row.removeClass('form-group_confirm');
                                            $this.val('');
